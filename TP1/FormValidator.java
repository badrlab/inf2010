...
public class FormValidator 
{
	...
	private static String generateCode(int length)
	{
		...
		for (int i=0; i<length;i++){
			int ascii_number = 0;
			ascii_number = generator.nextInt((91 - 65) + 1) + 65; //genere un nombre entre 65 et 91, soit les représentations numériques des lettres majuscules dans le code ASCII
			charKey[i] = (char) ascii_number;
			sb.append(charKey[i]);
		}
